...
class upload {
     ...
     * Translations can be in separate files, in a upload_class_lang/ subdirectory
     *
     * @access public
     * @var array
     */
    ...
    function upload($file, $lang = 'en_GB') {
        ...
        $this->lang               = $lang;
        if ($this->lang != 'en_GB' && file_exists(dirname(__FILE__).'/upload_class_lang') && file_exists(dirname(__FILE__).'/upload_class_lang/class.upload.' . $lang . '.php')) {
            $translation = null;
            include(dirname(__FILE__).'/upload_class_lang/class.upload.' . $lang . '.php');
