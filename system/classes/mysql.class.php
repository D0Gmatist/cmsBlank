...
| Файл: mysql.php
-----------------------------------------------------
| Назначение: запись, чтение, удаление из БД
=====================================================
*/
...
<body>
	<div style="width: 700px;margin: 20px auto; border: 1px solid #D9D9D9; background-color: #F1EFEF; -moz-border-radius: 5px; -webkit-border-radius: 5px; border-radius: 5px; -moz-box-shadow: 0px 0px 8px rgba(0, 0, 0, 0.3); -webkit-box-shadow: 0px 0px 8px rgba(0, 0, 0, 0.3); box-shadow: 0px 0px 8px rgba(0, 0, 0, 0.3);font-size: 12px;" >
